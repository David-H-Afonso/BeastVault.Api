...
public interface ITagService
{
    ...
    Task<TagDto?> CreateTagAsync(int userId, CreateTagRequest request);
    Task<TagDto?> UpdateTagAsync(int userId, int tagId, UpdateTagRequest request);
    ...
    Task<BulkTagResult> BulkUpdateTagsAsync(int userId, BulkTagRequest request);
}
