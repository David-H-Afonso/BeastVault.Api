...
namespace BeastVault.Api.Migrations
{
    ...
    [Migration("20260405135628_AddMultiUserSupport")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeastVault.Api.Domain.Entities.UserEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BeastVault.Api.Domain.Entities.FileEntity", b =>
                {
                    b.HasOne("BeastVault.Api.Domain.Entities.UserEntity", "User")
                        .WithMany("Files")
