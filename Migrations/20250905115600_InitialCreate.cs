...
namespace BeastVault.Api.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        {
            // Verificar si la tabla Files ya existe antes de crearla
            ...
            // Continuamos con las demás tablas si es necesario
            // Comentamos la creación original ya que la hemos reemplazado con la versión IF NOT EXISTS
...
migrationBuilder.CreateTable(
    ...
    columns: table => new
    {
        ...
        DynamaxLevel = table.Column<int>(type: "INTEGER", nullable: false),
        CanGigantamax = table.Column<bool>(type: "INTEGER", nullable: false),
