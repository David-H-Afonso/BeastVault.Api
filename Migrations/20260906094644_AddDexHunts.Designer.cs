...
namespace BeastVault.Api.Migrations
{
    ...
    [Migration("20260906094644_AddDexHunts")]
    partial class AddDexHunts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeastVault.Api.Domain.Entities.DexHuntItemEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("HuntListId", "IsCaught");

                    b.HasIndex("HuntListId", "SortOrder");

                    b.HasIndex("HuntListId", "SpeciesId")
                        .IsUnique();

                    b.ToTable("DexHuntItems");
                });

            modelBuilder.Entity("BeastVault.Api.Domain.Entities.DexHuntListEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BeastVault.Api.Domain.Entities.DexHuntItemEntity", b =>
                {
                    b.HasOne("BeastVault.Api.Domain.Entities.DexHuntListEntity", "HuntList")
                        .WithMany("Items")
                        .HasForeignKey("HuntListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HuntList");
                });

            modelBuilder.Entity("BeastVault.Api.Domain.Entities.DexHuntListEntity", b =>
                {
                    b.HasOne("BeastVault.Api.Domain.Entities.User", "User")
                        .WithMany("DexHuntLists")
